...
ClassImp(StMixedEventTriplet)

// _________________________________________________________
StMixedEventTriplet::StMixedEventTriplet(): mParticle1(NULL),mParticle2(NULL),mParticle3(NULL),
...
// _________________________________________________________
StMixedEventTriplet::StMixedEventTriplet(StMixedEventTriplet const * t) : 
  mParticle1(t->mParticle3),mParticle2(t->mParticle2),mParticle3(t->mParticle3),
...
//------------------------------------
StMixedEventTriplet::StMixedEventTriplet(StPicoTrack const * const particle1, StPicoTrack const * const particle2, StPicoTrack const * const particle3,
					 float p1MassHypo, float p2MassHypo, float p3MassHypo,
					 StThreeVectorF const & vtx, float const bField)  : mParticle1(NULL),mParticle2(NULL),mParticle3(NULL),
					 mLorentzVector(StLorentzVectorF()), mDecayVertex(StThreeVectorF()),
					 mPointingAngle(std::numeric_limits<float>::quiet_NaN()), mDecayLength(std::numeric_limits<float>::quiet_NaN()),
					 mParticle1Dca(std::numeric_limits<float>::quiet_NaN()), mParticle2Dca(std::numeric_limits<float>::quiet_NaN()), 
					 mParticle3Dca(std::numeric_limits<float>::quiet_NaN()),
